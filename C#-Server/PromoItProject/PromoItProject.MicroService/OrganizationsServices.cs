...
{
    public static class OrganizationsServices
    {
        //http://localhost:7243/api/Organizations/Get
        //http://localhost:7243/api/Organizations/Get/email
        //http://localhost:7243/api/Organizations/GetCampaignsProducts
        //http://localhost:7243/api/Organizations/Add
        //http://localhost:7243/api/Organizations/Update/id
        //http://localhost:7243/api/Organizations/Remove/id
        [FunctionName("Organizations")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", "post", "put", "delete", Route = "Organizations/{action}/{param?}")] HttpRequest req, string action, string param)
        {

            string cmdName = "Organizations." + action;
            try
            {
