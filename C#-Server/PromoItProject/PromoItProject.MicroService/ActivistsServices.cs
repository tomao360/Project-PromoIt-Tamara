...
{
    public static class ActivistsServices
    {
        //http://localhost:7243/api/Activists/Get
        //http://localhost:7243/api/Activists/Get/email
        //http://localhost:7243/api/Activists/GetMostMoneyEarned
        //http://localhost:7243/api/Activists/GetMostPromotedCampaigns
        //http://localhost:7243/api/Activists/Add
        //http://localhost:7243/api/Activists/Update/id
        //http://localhost:7243/api/Activists/Remove/id
        [FunctionName("Activists")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", "post", "put", "delete", Route = "Activists/{action}/{param?}")] HttpRequest req, string action, string param)
        {

            string cmdName = "Activists." + action;
            try
            {
