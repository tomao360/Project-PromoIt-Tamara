...
namespace PromoItProject.MicroService
{
    public static class ProductsServices
    {
        ...
        //http://localhost:7243/api/Campaigns/UpdateBought/id
        //http://localhost:7243/api/Campaigns/UpdateShipped/id
        [FunctionName("Products")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", "post", "put", "delete", Route = "Products/{action}/{param?}")] HttpRequest req, string action, string param)
        {
