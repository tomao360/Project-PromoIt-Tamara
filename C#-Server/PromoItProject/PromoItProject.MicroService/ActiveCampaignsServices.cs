...
{
    public static class ActiveCampaignsServices
    {
        //http://localhost:7243/api/ActiveCampaigns/Get
        //http://localhost:7243/api/Products/Get/id
        //http://localhost:7243/api/Products/GetCampaigns/id
        //http://localhost:7243/api/ActiveCampaigns/Add
        //http://localhost:7243/api/ActiveCampaigns/UpdateAddMoney/id
        //http://localhost:7243/api/ActiveCampaigns/UpdateSubtractMoney/id
        [FunctionName("ActiveCampaigns")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", "post", "put", Route = "ActiveCampaigns/{action}/{param?}")] HttpRequest req, string action, string param)
        {

            string cmdName = "ActiveCampaigns." + action;
            try
            {
