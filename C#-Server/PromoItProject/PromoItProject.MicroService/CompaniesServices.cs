...
namespace PromoItProject.MicroService
{
    ...
    {
        //http://localhost:7243/api/Companies/Get
        //http://localhost:7243/api/Companies/Get/email
        //http://localhost:7243/api/Companies/GetShipment
        //http://localhost:7243/api/Companies/GetShipmentByID/ID
        //http://localhost:7243/api/Companies/GetCountOfDonations
        //http://localhost:7243/api/Companies/Add
        //http://localhost:7243/api/Companies/Update/id
        //http://localhost:7243/api/Companies/Remove/id
        [FunctionName("Companies")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", "post", "put", "delete", Route = "Companies/{action}/{param?}")] HttpRequest req, string action, string param)
        {
            string cmdName = "Companies." + action;
            try
            {
